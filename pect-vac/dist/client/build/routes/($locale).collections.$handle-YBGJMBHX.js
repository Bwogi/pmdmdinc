import {
  useVariantUrl
} from "/build/_shared/chunk-BT4NRAP3.js";
import {
  At,
  Image,
  Money
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1692931300094.1445";
}
var meta = ({
  data
}) => {
...
function Collection() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "collection", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(At, { connection: collection.products, children: ({
      nodes,
      isLoading,
      PreviousLink,
      NextLink
...
//# sourceMappingURL=/build/routes/($locale).collections.$handle-YBGJMBHX.js.map
