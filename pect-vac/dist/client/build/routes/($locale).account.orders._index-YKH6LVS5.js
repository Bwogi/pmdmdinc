...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1692931300423.102";
}
var meta = () => {
  return [{
    title: "Orders"
...
function OrdersTable({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "acccount-orders", children: orders?.nodes.length ? /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(At, { connection: orders, children: ({
    nodes,
    isLoading,
    PreviousLink,
    NextLink
...
//# sourceMappingURL=/build/routes/($locale).account.orders._index-YKH6LVS5.js.map
