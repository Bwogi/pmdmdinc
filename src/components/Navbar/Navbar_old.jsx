...
const navigation = {
  ...
  categories: [
    {
      name: "Park's Pectus Excavatum Repair Tools",
      featured: [
        {
    ...
    {
      name: "Park's Pectus Carinatum Repair Tools",
      featured: [
        {
      ...
      <Transition.Root show={open} as={Fragment}>
        <Dialog as="div" className="relative z-40 lg:hidden" onClose={setOpen}>
          ...
          <div className="fixed inset-0 z-40 flex">
            ...
            >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-1 shadow-xl">
                        ...
                        <div className="grid grid-cols-2 gap-x-4 gap-y-10">
                          {category.featured.map((item) => (
                            <div key={item.name} className="group relative">
                              ...
                              <a target='_blank' rel="noreferrer" href={item.href} className="mt-6 block text-sm font-medium text-gray-900">
