    ...
    <div className="dark:bg-gray-900">
      <div className="container mx-auto relative">
        <div className="py-4 mx-4 md:mx-6">
          <div className="flex items-center justify-between border-gray-200 dark:border-gray-700 py-4">
            <div>
              <div
            ...
            <div className="hidden md:flex items-center space-x-4">
              <Link
                ...
                to="#"
                className="focus:outline-none focus:ring-1 focus:ring-gray-400 hover:bg-gray-100 p-0.5 rounded"
              >
                <svg
            ...
            <div className="md:hidden">
              <button
                ...
                className="focus:outline-none focus:ring-1 focus:ring-gray-400 rounded"
              >
                <svg
                  className="fill-stroke text-gray-800 dark:text-white"
                  width={24}
        ...
        >
          <div className="w-full">
            <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 pb-3 mx-4">
              ...
              <button
                ...
                className="text-gray-800 dark:text-white focus:outline-none focus:ring-1 focus:ring-gray-400"
              >
                <svg
          ...
          <div className="mt-4 mx-4">
            <ul className="flex flex-col space-y-4">
              <li className="border-b border-gray-200 dark:border-gray-700 dark:text-gray-700 pb-4 px-1 flex items-center justify-between">
                ...
                <button
                  aria-label="Add"
                  className="dark:text-white text-gray-800 focus:outline-none focus:ring-1 focus:ring-gray-400 rounded hover:bg-gray-100 dark:hover:bg-gray-700"
                >
                  <svg
                    className="fill-stroke"
                    width={16}
          ...
          <div className="w-full h-full flex items-end">
            <ul className="bg-gray-50 dark:bg-gray-800 py-10 px-4 flex flex-col space-y-8 w-full">
              <li>
                <Link
                  className="flex items-center space-x-2 focus:outline-none text-gray-800 dark:text-white focus:ring-1 focus:ring-gray-400 hover:underline"
                  to="#"
                >
                  <div>
                    <svg
              ...
              {/* <li>
                <Link
                  className="flex items-center space-x-2 text-gray-800 dark:text-white focus:outline-none focus:ring-1 focus:ring-gray-400 hover:underline"
                  to="#"
                >
                  <div>
                    <svg
