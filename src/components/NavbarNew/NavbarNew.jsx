  ...
  return (
    <>
      <div className="h-full w-full">
        ...
        <nav
          role="navigation"
          className="md:px-6 px-4  w-full mx-auto hidden md:block bg-gray-600 shadow-md"
        >
          <div className="container bg-gray-600 justify-between py-5 flex items-center md:items-stretch mx-auto border-b border-gray-200 border-opacity-20">
            <div className="h-full flex items-center">
              ...
              >
                ...
                <img src="/img/pmdmdLogo.png" alt="" className="h-20" />
              </button>
            </div>
