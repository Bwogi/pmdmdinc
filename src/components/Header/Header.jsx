    ...
    return (
        ...
        <div className="mx-auto max-w-7xl py-3 px-4 sm:py-8 sm:px-6 lg:px-8">
          <div className="flex flex-col justfy-center items-center text-center gap-5">
            <h2 className="text-[12px] rounded-md border border-gray-300 text-gray-500 w-[45%] p-2 bg-orange-50">INTRODUCING PEDIATRIC MEDICAL DEVICE MARKETING AND DISTRIBUTION LLC </h2>
