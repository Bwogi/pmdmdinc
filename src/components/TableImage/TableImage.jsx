    ...
    return (
        <>
            <div className="xl:w-3/4 2xl:w-4/5 w-full bg-white rounded-lg shadow">
                <div className="py-2 md:py-2 pl-8">
                        <h1 className="text-base md:text-lg lg:text-3xl text-gray-800">Park's <span className="text-orange-300 ">Modified Pectus</span> Bar</h1>
                </div>
                <div className="border rounded-lg border-gray-100">
                    <div className="py-4 md:py-6 pl-8">
                        <p className="text-base md:text-lg lg:text-xl font-bold leading-tight text-gray-800">Modified Pectus Bar - Rounded end</p>
                    </div>
