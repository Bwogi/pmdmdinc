    ...
    return (
      <>
        {/* <PageHeading title='About' /> */}
            <div className="xl:container xl:mx-auto mt-2">
                <div className=" flex flex-col md:flex-row items-strech justify-center">
                    <div className="md:w-3/5 relative">
                        <img src="https://i.ibb.co/2Y2W5h2/florian-klauer-mk7-D-4-UCfmg-unsplash-1.png" alt="A typewriter"  className="absolute inset-0 object-cover object-center w-full h-full hidden lg:block rounded" />
                        <img src="https://i.ibb.co/PZRDh0s/florian-klauer-mk7-D-4-UCfmg-unsplash-1-1-1.png" alt="A typewriter"  className="absolute inset-0 object-cover object-center w-full h-full lg:hidden rounded" />
                        <img src="https://i.ibb.co/CsYRYtk/florian-klauer-mk7-D-4-UCfmg-unsplash-1-1.png" alt="A typewriter"  className="object-cover object-center w-full h-full md:hidden rounded" />
                    </div>
