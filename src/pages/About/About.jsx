...
import WhyPMDMD from "../../components/WhyPMDMD/WhyPMDMD";
  ...
  return (
    <div className="bg-white mt-10">
      ...
      <main className="isolate">
        ...
        <div className="relative isolate -z-10 overflow-hidden bg-gradient-to-b from-green-100/20 pt-14">
          ...
          <div className="mx-auto max-w-7xl px-6 py-32 sm:py-40 lg:px-8">
            <div className="mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-6 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">
              <h1 className="max-w-2xl text-3xl font-bold tracking-tight text-gray-400 sm:text-5xl lg:col-span-2 xl:col-auto">
                Welcome to <br />
                <span className="text-gray-600">
                  Pediatric Medical Device Marketing and Distribution
                </span>
              </h1>
              ...
              <div className="mt-6 max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1">
                ...
                <div className="lg:col-end-1 mt-20 lg:w-full lg:max-w-lg lg:pb-8">
                  ...
                  <h2 className="text-3xl font-bold tracking-tight text-gray-600 sm:text-3xl">
                    Who we are
                  </h2>
                  <p className="mt-6 text-xl leading-8 text-gray-600">
                    We are a team of dedicated professionals with diverse
                    expertise in pediatric medicine, device engineering,
        ...
        {/* Content section */}
        <div className="mt-18 overflow-hidden sm:mt-10">
          <div className="mx-auto max-w-7xl px-6 lg:flex lg:px-8">
            <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-16 lg:mx-0 lg:min-w-full lg:max-w-none lg:flex-none lg:gap-y-8">
              <div className="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
                ...
                <p className="mt-6 text-xl leading-8 text-gray-600">
                  At Pediatric Medical Device Marketing and Distribution LLC,
                  our vision is to be at the forefront of pediatric healthcare
                  innovation.
                </p>
                <p className="mt-6 text-base leading-7 text-gray-600">
                  We aspire to create a world where children have access to
                  state-of-the-art medical technologies that cater to their
                  unique needs, ensuring their well-being and supporting their
        ...
        {/* <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            <p className="mt-6 text-base leading-7 text-gray-600">
              We are a team of dedicated professionals with diverse expertise in
              pediatric medicine, device engineering, marketing, and
              distribution. Our collective passion for improving pediatric care
              fuels our efforts to identify, curate, and deliver groundbreaking
              medical solutions that address a wide range of health challenges
              faced by children.
            </p>
          </div>
        </div> */}
        <div className="px-20 mr-20 flex flex-col gap-5 text-gray-600">
          ...
          <p>
            ...
            manufacturers, and healthcare organizations to drive advancements in
            pediatric medical devices. For inquiries, partnerships, and more
            information, please reach out to us at{" "}
            <span className="font-bold">
              <a href="mailto:info@pmdmdllc.com">info@pmdmdllc.com</a>
            </span>
            .
          </p>
          <p>
            Thank you for joining us on our journey to transform pediatric
            healthcare through innovation and accessibility. Together we can
            create a healthier and brighter future for children worldwide.
          </p>
          <p>Sincerely,</p>
            ...
            <div className="mt-10 xl:mt-0">
              ...
              <form className="mt-6 sm:flex sm:max-w-md">
                ...
                <input
                  ...
                  autoComplete="email"
                  required
                  className="w-full min-w-0 appearance-none rounded-md border-0 bg-white px-3 py-1.5 text-base text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-green-600 sm:w-64 sm:text-sm sm:leading-6 xl:w-full"
