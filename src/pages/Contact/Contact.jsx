...
function Contact() {
  ...
  <div className="lg:max-w-[1440px] md:max-w-[744px] max-w-[375px] w-full mx-auto py-12  bg-white relative">
      ...
      <iframe title="lafayette" className="relative" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d100754.28700647665!2d-122.19289849493923!3d37.89370325014323!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8085607ca3fa8f85%3A0xf928585d03e46927!2sLafayette%2C%20CA!5e0!3m2!1sen!2sus!4v1671613833484!5m2!1sen!2sus" width="100%" height={600} style={{border: 0}} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
      <div>
        <svg className="absolute inset-x-0 w-3/4 mx-auto mb-auto cursor-pointer loc md:w-2/5 lg:inset-y-0 lg:my-auto inset-y-10" width={44} height={52} viewBox="0 0 44 52" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M22 52C23.496 52 29.344 47.728 34.004 42.428C40.216 35.368 44 27.488 44 20C44 8.148 34.26 0 22 0C9.74 0 0 8.148 0 20C0 27.52 3.784 35.4 9.996 42.452C14.652 47.74 20.5 52 22 52ZM22 24.8C23.0609 24.8 24.0783 24.3786 24.8284 23.6284C25.5786 22.8783 26 21.8609 26 20.8C26 19.7391 25.5786 18.7217 24.8284 17.9716C24.0783 17.2214 23.0609 16.8 22 16.8C20.9391 16.8 19.9217 17.2214 19.1716 17.9716C18.4214 18.7217 18 19.7391 18 20.8C18 21.8609 18.4214 22.8783 19.1716 23.6284C19.9217 24.3786 20.9391 24.8 22 24.8ZM22 33.6C18.6052 33.6 15.3495 32.2514 12.949 29.851C10.5486 27.4505 9.2 24.1948 9.2 20.8C9.2 17.4052 10.5486 14.1495 12.949 11.749C15.3495 9.34857 18.6052 8 22 8C25.3948 8 28.6505 9.34857 31.051 11.749C33.4514 14.1495 34.8 17.4052 34.8 20.8C34.8 24.1948 33.4514 27.4505 31.051 29.851C28.6505 32.2514 25.3948 33.6 22 33.6Z" fill="#1F2937" />
        </svg>
      </div>
      <div className="absolute px-8 py-8 bg-white lg:top-28 lg:left-28 md:bottom-28 bottom-28 left-8 md:left-11 lg:max-w-[410px] md:max-w-[648px] max-w-[311px] w-full lg:max-h-[356px] set">
        <p className="mb-4 text-3xl font-bold lg:leading-[48px] md:leading-[36px] leading-[30px] text-gray-800 md:text-4xl lg:text-5xl">Get in Touch</p>
                <p className="text-base">Looking for our assistance? <span className="font-semibold text-indigo-700 underline cursor-pointer"><a href="mailto:contact@pmdmd-inc.com">Contact
                Us</a></span> </p>
        <div className="flex mt-8 gap-x-4">
          <svg className="cursor-pointer  h-[21px] mt-1" width={25} height={24} viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M12.1406 10.5C12.9787 10.5 13.6581 9.82843 13.6581 9C13.6581 8.17157 12.9787 7.5 12.1406 7.5C11.3025 7.5 10.623 8.17157 10.623 9C10.623 9.82843 11.3025 10.5 12.1406 10.5Z" fill="#4B5563" />
            <path d="M12.1405 1.5C7.95677 1.5 4.55273 4.71797 4.55273 8.67188C4.55273 10.5548 5.42105 13.0589 7.13351 16.1147C8.50878 18.5681 10.0998 20.7867 10.9274 21.8906C11.0672 22.0792 11.25 22.2326 11.461 22.3384C11.6721 22.4441 11.9053 22.4992 12.1419 22.4992C12.3785 22.4992 12.6117 22.4441 12.8227 22.3384C13.0337 22.2326 13.2166 22.0792 13.3564 21.8906C14.1825 20.7867 15.775 18.5681 17.1502 16.1147C18.8599 13.0598 19.7282 10.5558 19.7282 8.67188C19.7282 4.71797 16.3241 1.5 12.1405 1.5ZM12.1405 12C11.5402 12 10.9534 11.8241 10.4542 11.4944C9.95513 11.1648 9.56612 10.6962 9.3364 10.1481C9.10668 9.59987 9.04657 8.99667 9.16368 8.41473C9.28079 7.83279 9.56986 7.29824 9.99432 6.87868C10.4188 6.45912 10.9596 6.1734 11.5483 6.05764C12.1371 5.94189 12.7473 6.0013 13.3019 6.22836C13.8565 6.45542 14.3305 6.83994 14.664 7.33329C14.9975 7.82664 15.1755 8.40666 15.1755 9C15.1747 9.79538 14.8546 10.5579 14.2856 11.1204C13.7166 11.6828 12.9451 11.9991 12.1405 12Z" fill="#4B5563" />
          </svg>
          <p className="text-base leading-normal text-gray-600 ">P.O.BOX 1755,  <br /> Lafayette, CA 94549, USA </p>        
        </div>
        <div className="flex mt-8 gap-x-4">
...
//               </div>
//               <button className="mt-8 lg:mt-10 px-8 py-4 hover:bg-indigo-600 bg-indigo-700 rounded text-base font-medium text-center text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700"><a href="mailto:contact@pmdmd-inc.com">Send Email</a> </button>
//             </div>
//           </div>
//         </div>
//       </div>
